...
def index(request):
    """Pagina principal do site, exibe todas as receitas"""
...
def atualiza_receita(request):
    """Atualiza uma receita  - auxilia o metodo edita_receita"""
    if request.method == 'POST':
        receita_id = request.POST['receita_id']
        r = Receita.objects.get(pk=receita_id)
        r.nome = request.POST['nome_receita']
